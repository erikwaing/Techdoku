...
In this paper, we consider the general problem of determining the fewest number of clues 

question of determining the fewest number of necessary clues wh formulated for general computational problems. Thus, for any given problem $A$



On the other hand, Sudoku
