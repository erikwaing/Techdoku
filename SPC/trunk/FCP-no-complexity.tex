...
The above procedure ``transfers" the information from the literals to the variables. We know that an $F$-partitioned literal must be true in some clause. That particular variable will make the clause true, so we set the variable accordingly. 
