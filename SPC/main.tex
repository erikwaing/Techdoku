...
\begin{definition}
Given a puzzle, or more generally an NP-Search problem, we call a partial assignment of entries or variables a determining set if it implies a unique solution. The smallest determining set is referred to as the minimal critical set. 
\end{definition}
